...
def process_cli(parser):
    parser.add_argument('--dry-run', action='store_true', dest='log')
    parser.add_argument('--seed', type=int, default=324823217)
    parser.add_argument('--network', choices=['resnet20', 'cnn', 'vit'], default='vit')
    ...
    parser.add_argument('--gpus', type=str, default='2,3,4,5,8')
    parser.add_argument('--process-per-gpu', type=int, default=1)
